...
export const ShadowOverlay = memo(function ShadowOverlay({
    sizing = 'fill',
    ...
    // Use CSS animation via SMIL instead of JS-driven setAttribute every frame
                        ...
                        <defs>
                            <filter id={id}>
                                ...
                                <feColorMatrix
                                    ...
                                    values="180"
                                >
                                    {/* Use SMIL animation instead of JS-driven setAttribute */}
                                    <animate
